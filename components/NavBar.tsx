...
const NavBar = () => {
  ...
  return (
    <div style={{
      ...
      {isMenuVisible && (
        <div ref={menuRef} onClick={(e) => e.stopPropagation()} className='bg-[#682E9E] mydiv z-10 space-y-7 box-border p-4 flex flex-col justify-center items-center rounded-bl-xl text-white w-[300px] top-[120px] absolute right-0 h-[300px]'>
          <Link href='/dashboard'><p className='hover:text-[#00C7A3] cursor-pointer'>Dashboard</p></Link>
          <Link href='/mypass'><p className='cursor-pointer hover:text-[#00C7A3]'>My pass</p></Link>
