...
const SideNav = () => {
    ...
    <div style={{
        backgroundImage: 'url(/gifimage.gif)', objectFit: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'
      }} className='h-[100vh] w-[100%] px-10 rounded-lg pb-10 relative text-white box-border p-10 flex flex-col md:items-start'>
            <div className='flex items-center justify-between w-full space-x-4'>
                <Image style={{borderRadius: '50%'}} className='rounded-[50%]' src='/ctrpNo.jpg' alt='logo' height={50} width={50} />
            ...
            <div className='w-[150px] flex items-center justify-evenly mb-2 mt-2'>
                {texts.map((_, index) => (
                    <div 
                        key={index}
