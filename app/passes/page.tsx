      ...
      <FaArrowAltCircleLeft className='text-[2.5rem] mb-4 text-white' />
        ...
        <div className='flex flex-col justify-center items-center my-10'>
          <div className='flex relative flex-col justify-center items-center p-5 rounded-2xl shadow-2xl bg-gradient-to-r border-[1px] border-gray-800 from-[#e3e649] via-[#ebee2d] to-[#e3e649] w-[250px] h-[350px]'>
            ...
            <div className='w-full h-[65%] rounded-[20px] bg-slate-800 mt-3 flex justify-center items-center flex-col'>
              <Image src='/whiteLogo.png' alt='logo' height={10} width={70} />
              <Image src='/two.jpeg' className='rounded-md' height={80} width={180} alt='profile' />
              <div className='flex items-center gap-x-4'>
                <RiHeart2Line className='text-white' />
                <p style={{ fontFamily: 'monospace' }} className='text-white mt-5 font-bold mb-4'>Kelvin Donald</p>
                <RiHeart2Line className='text-white' />
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-col justify-center items-center my-10'>
          <div className='flex relative flex-col justify-center items-center p-5 rounded-2xl shadow-2xl bg-gradient-to-r border-[1px] border-gray-800 from-[#f1f3e0] via-[#e8ebcd] to-[#f1f3e0] w-[250px] h-[350px]'>
            ...
            <div className='w-full h-[65%] rounded-[20px] bg-slate-800 mt-3 flex justify-center items-center flex-col'>
              <Image src='/whiteLogo.png' alt='logo' height={10} width={70} />
              <Image src='/one.jpeg' className='rounded-md' height={80} width={180} alt='profile' />
              <div className='flex items-center gap-x-4'>
                <RiHeart2Line className='text-white' />
                <p style={{ fontFamily: 'monospace' }} className='text-white mt-5 font-bold mb-4'>Athkins Alive</p>
                <RiHeart2Line className='text-white' />
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-col justify-center items-center my-10'>
          <div className='flex relative flex-col justify-center items-center p-5 rounded-2xl shadow-2xl bg-gradient-to-r border-[1px] border-gray-800 from-[#e3e649] via-[#ebee2d] to-[#e3e649] w-[250px] h-[350px]'>
            ...
            <div className='w-full h-[65%] rounded-[20px] bg-slate-800 mt-3 flex justify-center items-center flex-col'>
              <Image src='/whiteLogo.png' alt='logo' height={10} width={70} />
              <Image src='/three.jpeg' className='rounded-md' height={80} width={180} alt='profile' />
              <div className='flex items-center gap-x-4'>
                <RiHeart2Line className='text-white' />
                <p style={{ fontFamily: 'monospace' }} className='text-white mt-5 font-bold mb-4'>Gift Slate</p>
                <RiHeart2Line className='text-white' />
              </div>
            </div>
          </div>
