...
const Mainbar = () => {
    ...
    return (
        <div className='bg-[#1A1D1F] w-[100%] h-auto overflow-hidden flex justify-start items-center flex-col'>
            ...
            <div className='text-center font-bold mt-[30px] mb-[45px] flex justify-center items-center flex-col'>
            ...
            <div className='flex flex-col space-y-10 justify-center items-center mb-20'>
                <div className='w-[65vw] min-h-[600px] h-auto flex flex-col bg-transparent border-[1px] border-gray-200'>
                    <div className='w-[100%] h-[80px] flex justify-between px-7 items-center box-border text-white bg-purple-700'>
                    ...
                    <div className='flex justify-center w-[100%] items-center'>
                        <Image src='/one.jpeg' height={1000} width={1000} className='h-[350px] mt-7 w-[70%] rounded-lg border-[1px] border-gray-200 px-5' alt='pic' />
                    </div>

                    <div className='mt-10 w-[100%] flex mb-5 px-7 justify-between items-center'>
                ...
                <div className='w-[65vw] min-h-[600px] h-auto flex flex-col bg-transparent border-[1px] border-gray-200'>
                    ...
                    <div className='flex justify-center w-[100%] items-center'>
                        <Image src='/two.jpeg' height={1000} width={1000} className='h-[350px] mt-7 w-[70%] rounded-lg border-[1px] border-gray-200 px-5' alt='pic' />
                    </div>
                    ...
                    <div className='mt-10 w-[100%] flex mb-5 px-7 justify-between items-center'>
                        ...
                        <button className='bg-red-700 text-[1rem] h-[40px] w-[150px] text-white rounded-lg flex items-center justify-center gap-x-3'><MdDeleteForever className='text-[1.7rem]' />Delete</button>
                        {/* <button className='bg-purple-700 text-[1rem] h-[40px] w-[150px] text-white rounded-lg flex items-center justify-center gap-x-3'><FaGift className='text-[1.7rem]' />Gift</button> */}
                    </div>
